...
useRouteMatch is a hook that allows developers to code nested routes to the app. It helps streamline routes that only a single paramater would have to be adjusted without having to change entire lines of code.

2. How would you explain form validation to someone who has never programmed before?

Form validation acts as a barrier to help prevent users from submitting an incomplete form and letting the user know what is missing in order for submission to work.

3. In 1-2 sentences, define end to end testing.

"End to End" is a method of testing that takes a look at the whole user experience, practically from every angle. The testing can be done through automation programs like cypress to check on validation, button functionality, form loading, etc.
